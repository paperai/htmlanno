...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__bioes__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__bioes___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__bioes__);
...
__WEBPACK_IMPORTED_MODULE_1_jquery___default()(() => {
  __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].component('html_viewer', {
    ...
    methods: {
      loadUri: (uri) => {
        return new Promise((resolve, reject) => {
          __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get(uri).then((http_response) => {
      ...
      parseBioes: (bioes) => {
        return new Promise((resolve, reject) => {
          const parser = new __WEBPACK_IMPORTED_MODULE_3__bioes___default.a()
          parser.parse(bioes)
          resolve(parser)
        })
      }
  ...
  const vueObj = new __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */]({
    el: '#viewerWrapper',
    data: () => {
      return {};
    },
