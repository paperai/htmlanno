...
QUnit.module('SpanAnnotation', {
  ...
  beforeEach: () => {
    ...
    this.instance = new SpanAnnotation(this.dummyStart, this.dummyEnd, 'test label 1');
  ...
  QUnit.skip('TODO: 大幅に仕様が変わっているので作り直す: constructor should set argument to #elements, and update #topElements, #circle and #jObject', (assert) => {
  ...
  test('getClassName() should return "htmlanno-hl-" + #uuid + "-" + #referenceId when it has referenceId', (assert) => {
    const withReferenceId = new SpanAnnotation(
